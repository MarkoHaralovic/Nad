				...
				\subsubsection{Opis obrazaca uporabe}				
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik klikne na opciju "Zatraži prijevod knjige"
                            					\item U bazi podataka se inkrementira broj zatraženih prijevoda od neregistriranih korisnika za tu knjigu
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik ispunjuje barem jedno od sljedećih polja: naziv knjige, naziv autora, godina izdanja, redni broj izdanja, kategorija izdavača, žanr knjige, ISBN, oznaka vrste knjige i ime ponuditelja
