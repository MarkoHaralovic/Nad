\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtblr}[
				...
				Izrada početne stranice			        &  &  & 5 & 7 &  &  &  \\  
                Izrada stranica za objave               &  &  & 3 & 5 &  &  &  \\
                Izrada stranice za novu objavu          &  &  & 2 & 3 &  &  &  \\  
                Izrada stranice za login i registraciju &  &  & 5 & 2 &  &  &  \\ 
                Izrada stranice za pregled računa       &  &  & 4 & 5 &  &  &  \\  
                Izrada skripti za funkcionalnost stranice &  &  & 4 & 6 &  &  &  \\  
                Omogućavanje responzivnosti stranice    &  &  & 3 & 5 &  &  &  \\ 
